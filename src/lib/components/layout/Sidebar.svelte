...
<div
	...
	class="h-screen max-h-[100dvh] min-h-screen select-none {$showSidebar
		...
		: '-translate-x-[260px] w-[0px]'} {IS_TAURI_DESKTOP
		? 'pt-[15px]'
...
>
	<div
		class="py-2 my-auto flex flex-col justify-between h-full max-h-[100dvh] w-[260px] overflow-x-hidden z-50 {$showSidebar
			? ''
			: 'invisible'}"
	>
